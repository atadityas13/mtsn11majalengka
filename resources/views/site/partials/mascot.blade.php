@if ($site->mascotIsVisible())
    @php
        $scriptMessages = collect(preg_split('/\r\n|\r|\n/', (string) $site->mascot_message))
    ...
    @if (count($scriptMessages))
        ...
        >
            ...
            >
                ...
                <div class="site-mascot-hint">Klik robot untuk menyembunyikan sementara</div>
            </div>
            ...
            <button
                ...
                @click="onTap()"
                :aria-label="talking ? 'Sembunyikan robot' : 'Sembunyikan robot sementara'"
            >
